...
###############
        ...
        yield x,y,t, image[None],depth, intrinsics
...
if __name__ == '__main__':
    ...
    print(args.imagedir)
    tstamps = []
    for (x,y,t, image, depth,intrinsics) in tqdm(image_stream(args.imagedir,args.depthdir, args.calib, args.stride)):
        if t < args.t0:
            continue
        #print(depth)
        ...
        if droid is None:
            ...
            droid = Droid(args)
        #需要对depth进行处理。
        droid.track(x,y,t, image, depth, intrinsics=intrinsics)
